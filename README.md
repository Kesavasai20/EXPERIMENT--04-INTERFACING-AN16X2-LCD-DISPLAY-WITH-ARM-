...
```PY
  ...
  Lcd_cursor(&lcd, 1,0);
  Lcd_string(&lcd, "Kesava");
```
## Output screen shots of proteus  :
 ![image](https://github.com/user-attachments/assets/3e574fe4-6286-4ea2-90d2-1b74d35844ab)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/5cf4834d-f56a-41d6-9b5e-dc00f21d34ac)
